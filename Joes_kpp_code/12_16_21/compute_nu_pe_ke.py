...
def compute_nu_pe_ke_diag(U,V,Eta,rho,thknss,dxc,dyc,dxu,dyu,dxv,dyv,dxq,dyq,ugrid,vgrid,pgrid,post_taper=np.array([0,0,0]),
                     trim_ml=0,zoversamp=1,prd=np.array([1,1,1])):
    (dU,dV,phiHyd) = compute_nu_pe_ke(U,V,Eta,rho,thknss,dxc,dyc,dxu,dyu,dxv,dyv,dxq,dyq,
                                       ugrid,vgrid,pgrid,np.array([0,0,0]),trim_ml,zoversamp,prd);
    return (dU,dV,phiHyd);

def compute_nu_pe_ke_diag_u(U,V,Eta,rho,thknss,dxc,dyc,dxu,dyu,dxv,dyv,dxq,dyq,ugrid,vgrid,pgrid,post_taper=np.array([0,0,0]),
                     trim_ml=0,zoversamp=1,prd=np.array([1,1,1])):
    (dU,dV,_) = compute_nu_pe_ke(U,V,Eta,rho,thknss,dxc,dyc,dxu,dyu,dxv,dyv,dxq,dyq,
                                       ugrid,vgrid,pgrid,np.array([0,0,0]),trim_ml,zoversamp,prd);
...
def compute_nu_pe_ke_k(U,V,Eta,rho,thknss,dxc,dyc,dxu,dyu,dxv,dyv,dxq,dyq,ugrid,vgrid,pgrid,post_taper=np.array([1,1,0]),
                     trim_ml=0,zoversamp=1,prd=np.array([1,1,1])):
    (dU,dV,_) = compute_nu_pe_ke(U,V,Eta,rho,thknss,dxc,dyc,dxu,dyu,dxv,dyv,dxq,dyq,
...
def compute_nu_pe_ke_m(U,V,Eta,rho,thknss,dxc,dyc,dxu,dyu,dxv,dyv,dxq,dyq,ugrid,vgrid,pgrid,post_taper=np.array([1,1,0]),
                     trim_ml=0,zoversamp=1,prd=np.array([1,1,1])):
    (dU,dV,_) = compute_nu_pe_ke(U,V,Eta,rho,thknss,dxc,dyc,dxu,dyu,dxv,dyv,dxq,dyq,
                                                    ugrid,vgrid,pgrid,post_taper,trim_ml,zoversamp,prd);
...
def compute_nu_pe_ke(U,V,Eta,rho,thknss,dxc,dyc,dxu,dyu,dxv,dyv,dxq,dyq,ugrid,vgrid,pgrid,post_taper=np.array([1,1,0]),
                     trim_ml=0,zoversamp=1,prd=np.array([1,1,1])):
