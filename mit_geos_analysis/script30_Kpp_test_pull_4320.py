...
if __name__ == "__main__":
    ...
    fsize=0   ## <<==== don't mode
    fol = '/nobackup/amondal/NCData/Hector_CCS_Kappa/'
    MIT_xr_date_location_fol('oceQsw',0,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
