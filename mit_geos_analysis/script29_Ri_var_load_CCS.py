...
if __name__ == "__main__":
    ...
    fsize=0   ## <<==== don't mode
    fol = '/nobackup/amondal/NCData/20220301_diagnostic_vars_for_Ri_layers0_40_CCS/'
    MIT_xr_date_location_fol('KPPhbl',0,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
    for depth in range(0,40):
        MIT_xr_date_location_fol('Theta',depth,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
        MIT_xr_date_location_fol('Salt',depth,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
        MIT_xr_date_location_fol('U',depth,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
        MIT_xr_date_location_fol('V',depth,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
