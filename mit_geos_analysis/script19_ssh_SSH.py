...
if __name__ == "__main__":
   ...
   #                      resource_spec='select=16:ncpus=10:model=sky_ele',
    ...
    fsize=0   ## <<==== don't mode
    fol = '/nobackup/amondal/NCData/20220111_SSH_spectra_practice/'
    ...
    MIT_xr_date_location_fol('Eta',0,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
