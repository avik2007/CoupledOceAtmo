...
if __name__ == "__main__":
    ...
    client = Client(memory_limit='4GB',n_workers = 10, threads_per_worker=1)
    #client
    ...
    fsize=0   ## <<==== don't mode
    fol = '/nobackup/amondal/NCData/20210802_GSData/'
    ...
    #MIT_xr_date_location_fol('V',0,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
    #MIT_xr_date_location_fol('U', 0, ffilter, fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2, lat1,lat2,latinc,lon1,lon2,loninc,fol)
