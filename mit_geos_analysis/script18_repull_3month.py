...
if __name__ == "__main__":
    ...
    client = Client(memory_limit='60GB',n_workers = 20, threads_per_worker=1)
    #client
   ...
   #                      resource_spec='select=16:ncpus=10:model=sky_ele',
    ...
    #MIT_xr_date_location_fol('HAdv',34,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
    #MIT_xr_date_location_fol('Theta',34,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
    MIT_xr_date_location_fol('HAdv',22,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
    MIT_xr_date_location_fol('Theta',22,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
    #MIT_xr_date_location_fol('KPPhbl',levels,ffilter,fsize,y1,m1,d1,h1,M1,y2,m2,d2,h2,M2,lat1,lat2,latinc,lon1,lon2,loninc,fol)
    for level in range(40,42):
